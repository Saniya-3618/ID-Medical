...
@scheduler.scheduled_job(trigger=IntervalTrigger(minutes=10), id='scraping_3_days')
...
@scheduler.scheduled_job(trigger='cron', day_of_week='fri', hour=11, minute=3, id='delete_files')
