...
def task_3_days_scraping():
    ...
    scheduler.add_job(task_3_days_scraping, trigger=IntervalTrigger(minutes=20), id='scraping_28_days')

#@scheduler.scheduled_job(trigger=CronTrigger(hour=14, minute=45), id='delete_files')
