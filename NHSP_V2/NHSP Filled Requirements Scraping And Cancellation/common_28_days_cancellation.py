class Constants:
    ...
    RECORDS_NOT_FOUND_TABLE_CLASS_NAME = 'search_notice_table'
    ...
    EXPORT_EXCEL_DOWNLOAD_PATH = 'C:\\Users\\saniya.pathan\\Downloads\\filled\\28_days\\'
    PROJECT_PATH = 'D:\\EPI_Saniya\\Id-Medical_old\\NHSP_V2\\NHSP Filled Requirements Scraping And Cancellation\\'
    
    EXECUTION_LOGS_FOLDER = 'execution_logs'
    EXECUTION_SCREENSHOTS_FOLDER = 'screenshots'
    EXPORTED_EXCELS_FOLDER = 'exported_excels'
    FILLED_REQUIREMENTS_EXCELS_FOLDER = '28_days_requirements_excels\\filled'
    UNFILLED_REQUIREMENTS_EXCELS_FOLDER = '28_days_requirements_excels\\unfilled'
    ...
    EXCEL_COLUMN_HEADERS_LIST = ['Booking Reference Number', 'Location', 'Ward', 'Shift Date', 'Start Time', 'End Time', 'Assignment Code', 'Status', 'First Name', 'Last Name', 'Agency Name', 'Notes', 'Gender']
